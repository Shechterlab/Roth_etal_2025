...
BED_FILES=(
    histone_genes/histone_genes_HDB20.bed
    histone_genes/histoneH2A_genes_HDB20.bed
    histone_genes/histoneH2B_genes_HDB20.bed
    histone_genes/histoneH3_genes_HDB20.bed
    histone_genes/histoneH4_genes_HDB20.bed
    histone_genes/histoneH1_genes_HDB20.bed
)
...
computeMatrix scale-regions \
    -R "${BED_FILES[@]}" \
    -S "${PROSEQ_FILES[@]}" \
    --regionBodyLength ${REGIONBODY} \
    -b ${UPSTREAM} -a ${DOWNSTREAM} \
    --skipZeros \
    --binSize ${BINSIZE} \
    --numberOfProcessors ${THREADS} \
    --outFileName deeptools_output-mat/matrix_proseq_scaled.gz \
    --outFileSortedRegions deeptools_output-mat/sorted_regions_proseq_scaled.bed \
    --missingDataAsZero \
    --verbose

# PlotHeatmap with correct regionsLabel
plotHeatmap \
    -m deeptools_output-mat/matrix_proseq_scaled.gz \
    -out deeptools_output-pdf/heatmap_proseq_scaled.pdf \
    --colorMap Blues \
...
computeMatrix reference-point \
    ...
    --binSize ${BINSIZE} \
    --numberOfProcessors ${THREADS} \
    --outFileName deeptools_output-mat/matrix_cutrun_scaled.gz \
    --outFileSortedRegions deeptools_output-mat/sorted_regions_cutrun_scaled.bed \
    --missingDataAsZero \
    --verbose

# PlotHeatmap
plotHeatmap \
    -m deeptools_output-mat/matrix_cutrun_scaled.gz \
    -out deeptools_output-pdf/heatmap_cutrun_scaled.pdf \
    --colorMap Greens \
